<template>
  <nav class="flex justify-between py-4 smooth-shadow-black dark:smooth-shadow-white fixed top-0 w-[100%]">
    <router-link :to="{name: 'home'}" class="mx-4">
      <img class="w-12" :src="isDarkMode ? lightOqslogo : darkOqslogo" alt="ows-logo"/>
    </router-link>
    <div class="flex mx-4 items-center">
      ...
      <logo-link :logo="isDarkMode ? lightGithubLogoUrl : darkGithubLogoUrl" link="https://github.com/TheInspiredConjurer/Online-Questionnaire-System" small/>
      <DarkModeToggleButton v-model="isDarkMode" />
    </div>
  </nav>
</template>
